...
public class ShardedJedis extends BinaryShardedJedis implements JedisCommands {
	...
	public Long rpush(String key, int dbindex, String... strings) {
		Jedis j = getShard(key);
		j.select(dbindex);
		return j.rpush(key, strings);
	}
	...
	public Long lpush(String key, int dbindex, String... strings) {
		Jedis j = getShard(key);
		j.select(dbindex);
		return j.lpush(key, strings);
	}
	...
	public Long lpushx(String key, String string, int dbindex) {
		Jedis j = getShard(key);
		j.select(dbindex);
		return j.lpushx(key, string);
	}
	...
	public Long rpushx(String key, String string, int dbindex) {
		Jedis j = getShard(key);
		j.select(dbindex);
		return j.rpushx(key, string);
	}
	...
	public Long zadd(String key, Map<Double, String> scoreMembers, int dbindex) {
		Jedis j = getShard(key);
		j.select(dbindex);
		return j.zadd(key, scoreMembers);
	}
	...
	public Set<Tuple> zrangeWithScores(String key, long start, long end, int dbindex) {
		Jedis j = getShard(key);
		j.select(dbindex);
		return j.zrangeWithScores(key, start, end);
	}
	...
	public Set<Tuple> zrevrangeWithScores(String key, long start, long end, int dbindex) {
		Jedis j = getShard(key);
		j.select(dbindex);
		return j.zrevrangeWithScores(key, start, end);
	}
	...
	public Set<String> zrangeByScore(String key, String min, String max, int dbindex) {
		Jedis j = getShard(key);
		j.select(dbindex);
		return j.zrangeByScore(key, min, max);
	}
	...
	public Set<String> zrevrangeByScore(String key, String max, String min, int dbindex) {
		Jedis j = getShard(key);
		j.select(dbindex);
		return j.zrevrangeByScore(key, max, min);
	}
	...
	public Set<String> zrangeByScore(String key, String min, String max, int offset, int count, int dbindex) {
		Jedis j = getShard(key);
		j.select(dbindex);
		return j.zrangeByScore(key, min, max, offset, count);
	}
	...
	public Set<String> zrevrangeByScore(String key, String max, String min, int offset, int count, int dbindex) {
		Jedis j = getShard(key);
		j.select(dbindex);
		return j.zrevrangeByScore(key, max, min, offset, count);
	}
	...
	public Set<Tuple> zrangeByScoreWithScores(String key, String min, String max, int dbindex) {
		Jedis j = getShard(key);
		j.select(dbindex);
		return j.zrangeByScoreWithScores(key, min, max);
	}
	...
	public Set<Tuple> zrevrangeByScoreWithScores(String key, String max, String min, int dbindex) {
		Jedis j = getShard(key);
		j.select(dbindex);
		return j.zrevrangeByScoreWithScores(key, max, min);
	}
	...
	public Set<Tuple> zrangeByScoreWithScores(String key, String min, String max, int offset, int count, int dbindex) {
		Jedis j = getShard(key);
		j.select(dbindex);
		return j.zrangeByScoreWithScores(key, min, max, offset, count);
	}
	...
	public Set<Tuple> zrevrangeByScoreWithScores(String key, String max, String min, int offset, int count, int dbindex) {
		Jedis j = getShard(key);
		j.select(dbindex);
		return j.zrevrangeByScoreWithScores(key, max, min, offset, count);
	}
	...
	public Long zremrangeByScore(String key, String start, String end, int dbindex) {
		Jedis j = getShard(key);
		j.select(dbindex);
		return j.zremrangeByScore(key, start, end);
	}
