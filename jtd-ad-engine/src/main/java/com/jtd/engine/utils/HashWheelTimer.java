...
import com.jtd.engine.utils.TimerTask.Type;
...
public class HashWheelTimer implements Timer {
	 ...
	 *         2011-7-25
	 */
	private final class HashWheelTimerFuture implements com.jtd.engine.utils.TimerFuture {
	...
	public HashWheelTimer(final boolean daemon, final int tick, int ticksPerWheel) {
		...
		//Set<HashWheelTimerFuture>[]：初始化存放定时任务的hashWheel，默认是1024个
	 ...
	 * @see
	 */
	public com.jtd.engine.utils.TimerFuture timing(TimerTask task) {
