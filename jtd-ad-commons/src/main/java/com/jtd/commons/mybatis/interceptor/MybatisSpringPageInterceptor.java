package com.jtd.commons.mybatis.interceptor;
...
public class MybatisSpringPageInterceptor implements Interceptor {
	 ...
	 * @throws SQLException
	 */
	protected void queryTotalRecord(Pagination<?> page, Object parameterObject, MappedStatement mappedStatement,
		...
		try {
			...
			if (rs.next()) {
				int totalRecord = (int) rs.getLong(1);
	...
	protected String buildCountSql(String sql) {
		...
		return "select count(*) " + sqlStr.substring(index);
	}
