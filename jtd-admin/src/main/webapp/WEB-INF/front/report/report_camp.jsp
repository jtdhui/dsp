...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#down_btn").click(function(){
			$("#form1").attr("action","${pageContext.request.contextPath}/front/report/getCampExcel.action");
			$("#form1").submit();
			$("#form1").attr("action","${pageContext.request.contextPath}/front/report/camp.action");
		});
	});
...
<body>
	...
	<div class="wrapper">
        ...
        <form id="form1" action="${pageContext.request.contextPath}/front/report/camp.action" method="post">
        
        <!-- 查询条件，汇总显示，二级链接 -->
        <jsp:include page="/WEB-INF/front/report/report_top.jsp?param=camp"></jsp:include>
            ...
            <div class="index_preview_table">
                <table class="footable table table-stripped" data-filter=#filter>
                    <thead>
	                    <tr>
	                        <!-- 固定展示列 -->
	                        <th width="8%" onclick="orderBy('camp_id')" width="8%">ID <img id="camp_id_desc" class="order"/></th>
                            <th width="10%" style="cursor:auto;">活动名称</th>
                            <th width="8%" style="cursor:auto;">活动状态</th>
	                        <!-- 展示自定义列 -->
