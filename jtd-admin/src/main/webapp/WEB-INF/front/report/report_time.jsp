...
<script type="text/javascript">
	...
	$(function(){
        ...
        <%--$("#name_search_btn").click(function () {--%>
            ...
            <%--location.href =  "${baseurl }front/report/time.action?partnerName="+partnerName;--%>
        <%--});--%>
		...
		$("#down_btn").click(function(){
			$("#form1").attr("action","${pageContext.request.contextPath}/front/report/getTimeExcel.action");
			$("#form1").submit();
			$("#form1").attr("action","${pageContext.request.contextPath}/front/report/time.action");
		});
...
<body>
	...
	<div class="wrapper">
        ...
        <form id="form1" action="${pageContext.request.contextPath}/front/report/time.action" method="post">
            
        <!-- 查询条件，汇总显示，二级链接 -->
        <jsp:include page="/WEB-INF/front/report/report_top.jsp?param=time"></jsp:include>
            ...
            <div class="data_table_div">
                <div class="radio-wrap">
                    <span class="radio-style active">
                        <input id="r1" type="radio" value="1" name="selectLegendCheckbox" onclick="selectLegend()" checked>
            ...
            <div class="index_preview_table">
                <table class="footable table table-stripped" data-filter="#filter">
                    <thead>
	                    <tr>
	                    	<!-- 固定展示列 -->
	                        <th onclick="orderBy('date')">日期 <img id="date_desc" class="order"/></th>
	                        <!-- 展示自定义列 -->
