						...
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									...
									<form method="post"  action="${baseurl }admin/channel/addChannel.action"
										id="formId" class="form-horizontal" enctype="multipart/form-data">
										<div class="form-group">

											<label class="col-sm-1 control-label">渠道名称：</label> <input
												type="text" name="channelName" class="col-sm-1" value="" required>
										</div>
										<div class="form-group">

											<label class="col-sm-1 control-label">渠道类别体系：</label> <input
												type="text" name="catgserial" class="col-sm-1" value="" required>
										</div>
										<div class="form-group">

											<label class="col-sm-1 control-label">RTB PMP：</label> <input
												type="text" name="transType" class="col-sm-1" value="" required>
										</div>
										<div class="form-group">

											<label class="col-sm-1 control-label">广告类型：</label> <input
												type="text" name="adType" class="col-sm-1" value=""  required>
												
										</div>
										<div class="form-group">
										 <label
												class="col-sm-1 control-label">渠道展示地址：</label> <input
												type="text" name="websiteUrl" class="col-sm-1" value="" required>
										</div>
										<div class="form-group">
