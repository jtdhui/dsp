	...
	<div class="main-container">
		...
		<div class="main-content">
			...
			<div class="breadcrumbs" id="breadcrumbs">
				...
				<ul class="breadcrumb">
					<li><i class="icon-home home-icon"></i> <a
						href="${pageContext.request.contextPath}">角色管理</a></li>
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						<form id="form" class="form-horizontal" action="${baseurl }admin/role/insert.action" method="post">
							
							<div class="form-group has-info">
								<label class="col-xs-12 col-sm-3 control-label no-padding-right">角色名</label>
