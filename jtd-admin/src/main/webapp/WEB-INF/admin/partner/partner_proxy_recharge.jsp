...
<script type="text/javascript">
    $(function(){
        ...
        $("#button").click(function(){
            ...
            y_balance = parseFloat(y_balance*100).toFixed(0);
            amount = parseFloat(amount*100).toFixed(0);
            if(y_balance-amount<0){
                layer.msg("充值金额大于当前用户余额,请查看自己帐户余额再充值!");
                return ;
            }

            $.ajax({
                type:"post",
                url:"${pageContext.request.contextPath}/admin/partner/proxyRechargeSave.action",
                data:{"id": ${partner.id } , "amount":amount },
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form id="form" class="form-horizontal">
                        ...
                        <div class="form-group has-info">
                            <input id="y_balance" type="hidden" value="${activeUser.partner.accBalance}">
