		...
		$("#button").click(function(){
			...
			if(status==2){ //如果拒绝,备忘须填写原因
				if(remark=="" || remark ==null){
					layer.msg("您选择的是拒绝充值,需在备注里填写拒绝原因!");
					return ;
				}
			}else{
				if( amount == "" || /^\d+(\.\d{1,2})?$/.test(amount) == false || amount == 0){
					layer.msg("请输入充值金额，最多两位小数");
					return ;
				}
			}
					...
					<div class="col-xs-12">
						...
						<form id="form" class="form-horizontal">
							...
							<div class="form-group has-info">
								...
								<label class="col-xs-12 col-sm-3 control-label no-padding-right">推广费</label>
                            ...
                            <div class="form-group has-info">
                                ...
                                <label class="col-xs-12 col-sm-3 control-label no-padding-right">赠送</label>
                                <div class="col-xs-12 col-sm-1">
                                    <label class="control-label" id="pre_gift"><fmt:formatNumber value="${partnerPreFlow.preGift/100}" pattern="0.00"/>元</label>
                                </div>
                            </div>
							<div class="form-group has-info">
								<label class="col-xs-12 col-sm-3 control-label no-padding-right">充值状态</label>
                            ...
                            <div class="form-group has-info">
                                <label class="col-xs-12 col-sm-3 control-label no-padding-right">付款方式</label>
                                <div class="col-xs-12 col-sm-9">
                                    <label class="line-height-1 blue">
                                        <input name="payType" type="radio" class="ace" value="0" checked >
                                        <span class="lbl"> 先付</span>
                                    </label>
                                    <label class="line-height-1 blue">
                                        <input name="payType" type="radio" class="ace" value="1">
                                        <span class="lbl"> 后付 (付款方式,一经确定不可修改)</span>
                                    </label>
                                </div>
                            </div>
							<div class="form-group has-info">
								...
								<div class="col-xs-12 col-sm-9">
									<input type="text" id="amount" name="amount" class="width-20" value="<fmt:formatNumber value="${(partnerPreFlow.preAmount+partnerPreFlow.preGift)/100}" pattern="0.00"/>">
