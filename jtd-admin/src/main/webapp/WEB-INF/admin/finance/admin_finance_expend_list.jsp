...
<script type="text/javascript">
	$(function() {
        $("#expend_cycle").dateLayer("startDay","endDay",'${paraMap.startDay}','${paraMap.endDay}',"camp");
    });

    function exportExcel(){
        $("#form1").attr("action","${pageContext.request.contextPath}/admin/finance/downloadExpendReport.action");
        $("#form1").submit();
        $("#form1").attr("action","${pageContext.request.contextPath}/admin/finance/expendList.action");
    }
</script>
	...
	<div class="main-container-inner">
		...
		<div class="main-content">
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						<form method="post" action="${baseurl }/admin/finance/expendList.action" id="form1" class="form-horizontal">

                            <input type="hidden" id="proxyFlag" name="proxyFlag" value="0">
							<div class="form-group">
                                ...
                                <i class="throw_tit"></i><input class="yen_date" value="" id="expend_cycle">
